...
def open_to_neutral(pos=True,lag=0.005):

    '''
    Allows switching between a neutral position with the thumb slightly closed and a completely open position. A slightly closed thumb means the hand can take up less space.
    Inputs:
        - pos      A value of True will close the hand. A value of False will return it to open.
